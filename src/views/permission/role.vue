<template>
  <div class="app-container">
    ...
    <pagination v-show="total>0" :total="total" :page-sizes="listQuery.type" :page.sync="listQuery.page" :limit.sync="listQuery.limit" @pagination="getList" />
...
export default {
  ...
  methods: {
    getList() {
      roleApi.pageQuery(this.listQuery.page, this.listQuery.limit).then((res) => {
